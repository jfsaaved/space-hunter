...
public class PlanetState extends State {
    ...
    public PlanetState(GSM gsm){
        ...
        camp = new TextImage("          CAMP", options.getTextX(), astromech.getTextY() + astromech.getTextHeight(), 1, "camp");
        hunt = new TextImage("          HUNT", options.getTextX(), camp.getTextY() + camp.getTextHeight() , 1, "hunt");
        explore = new TextImage("       EXPLORE", options.getTextX(), hunt.getTextY() + hunt.getTextHeight(), 1, "explore");
